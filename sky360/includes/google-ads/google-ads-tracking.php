...
class Sky_SEO_Enhanced_Google_Ads {
    ...
    private function init_hooks() {
        ...
        // AJAX handlers for dedicated Google Ads dashboard
    ...
    public function ajax_get_google_ads_stats() {
        ...
        <?php if ($conversion_type === 'woocommerce' && class_exists('WooCommerce')): ?>
            ...
            <div class="sky-seo-woo-stats">
                <h3><?php esc_html_e('WooCommerce Conversion Details', 'sky360'); ?></h3>
                <div class="sky-seo-stats-grid">
                    <div class="sky-seo-stat-card">
                        <h4><?php esc_html_e('Total Orders', 'sky360'); ?></h4>
                        <div class="sky-seo-stat-value"><?php echo esc_html(number_format($woo_stats->total_orders)); ?></div>
                    </div>

                    <div class="sky-seo-stat-card">
                        <h4><?php esc_html_e('Total Revenue', 'sky360'); ?></h4>
                    ...
                    <div class="sky-seo-stat-card">
                        <h4><?php esc_html_e('Average Order Value', 'sky360'); ?></h4>
            ...
            <div class="sky-seo-campaigns">
                <h3><?php esc_html_e('Top Performing Campaigns', 'sky360'); ?></h3>
                <table class="widefat">
                    <thead>
                        <tr>
                            <th><?php esc_html_e('Campaign', 'sky360'); ?></th>
                            <th><?php esc_html_e('Orders', 'sky360'); ?></th>
                            <th><?php esc_html_e('Revenue', 'sky360'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <?php elseif ($conversion_type === 'form_submission'): ?>
            ...
            <div class="sky-seo-form-stats">
                <h3><?php esc_html_e('Form Submission Details', 'sky360'); ?></h3>
                <table class="widefat">
                    <thead>
                        <tr>
                            <th><?php esc_html_e('Form', 'sky360'); ?></th>
                            <th><?php esc_html_e('Submissions from Google Ads', 'sky360'); ?></th>
                            <th><?php esc_html_e('Last Submission', 'sky360'); ?></th>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="button button-small sky-seo-view-submissions"
                                        ...
                                        <?php esc_html_e('View Submissions', 'sky360'); ?>
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="4"><?php esc_html_e('No form submissions tracked yet.', 'sky360'); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
