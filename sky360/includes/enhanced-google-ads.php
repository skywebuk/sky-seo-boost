...
class Sky_SEO_Enhanced_Google_Ads {
    ...
    public function add_analytics_section() {
        ...
        <div class="sky-seo-analytics-section" id="google-ads-tracking">
            <h2><?php _e('Google Paid Ads Tracking', 'sky360'); ?></h2>
            <div class="sky-seo-google-ads-content">
                <div class="sky-seo-loading">
                    <span class="spinner is-active"></span>
                    <?php _e('Loading Google Ads data...', 'sky360'); ?>
                </div>
            </div>
        </div>
    ...
    public function ajax_get_google_ads_stats() {
        ...
        <?php if ($conversion_type === 'woocommerce' && class_exists('WooCommerce')): ?>
            ...
            <div class="sky-seo-woo-stats">
                <h3><?php _e('WooCommerce Conversion Details', 'sky360'); ?></h3>
                <div class="sky-seo-stats-grid">
                    <div class="sky-seo-stat-card">
                        <h4><?php _e('Total Orders', 'sky360'); ?></h4>
                        <div class="sky-seo-stat-value"><?php echo number_format($woo_stats->total_orders); ?></div>
                    </div>
                    
                    <div class="sky-seo-stat-card">
                        <h4><?php _e('Total Revenue', 'sky360'); ?></h4>
                    ...
                    <div class="sky-seo-stat-card">
                        <h4><?php _e('Average Order Value', 'sky360'); ?></h4>
            ...
            <div class="sky-seo-campaigns">
                <h3><?php _e('Top Performing Campaigns', 'sky360'); ?></h3>
                <table class="widefat">
                    <thead>
                        <tr>
                            <th><?php _e('Campaign', 'sky360'); ?></th>
                            <th><?php _e('Orders', 'sky360'); ?></th>
                            <th><?php _e('Revenue', 'sky360'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <?php elseif ($conversion_type === 'form_submission'): ?>
            ...
            <div class="sky-seo-form-stats">
                <h3><?php _e('Form Submission Details', 'sky360'); ?></h3>
                <table class="widefat">
                    <thead>
                        <tr>
                            <th><?php _e('Form', 'sky360'); ?></th>
                            <th><?php _e('Submissions from Google Ads', 'sky360'); ?></th>
                            <th><?php _e('Last Submission', 'sky360'); ?></th>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="button button-small sky-seo-view-submissions" 
                                        ...
                                        <?php _e('View Submissions', 'sky360'); ?>
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="4"><?php _e('No form submissions tracked yet.', 'sky360'); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            ...
            <div id="sky-seo-submissions-modal" style="display:none;">
                ...
                <div class="sky-seo-modal-content">
                    <div class="sky-seo-modal-header">
                        <h2 id="sky-seo-modal-title"><?php _e('Form Submissions', 'sky360'); ?></h2>
                        <button type="button" class="sky-seo-modal-close">&times;</button>
                    </div>
                    <div class="sky-seo-modal-body">
                        <div class="sky-seo-loading">
                            <span class="spinner is-active"></span>
                            <?php _e('Loading submissions...', 'sky360'); ?>
                        </div>
                    </div>
                </div>
            </div>
