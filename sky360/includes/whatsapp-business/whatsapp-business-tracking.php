...
class Sky_SEO_WhatsApp_Tracking {
    ...
    public function render_tracking_page() {
        ...
        if (!$table_exists) {
            ...
            <div class="notice notice-error">
                <p><?php esc_html_e('WhatsApp tracking table does not exist. Please deactivate and reactivate the plugin.', 'sky360'); ?></p>
            </div>
            <?php
            return;
        }
        ...
        <div class="sky-seo-analytics-dashboard sky-seo-whatsapp-tracking">
            ...
            <div class="sky-seo-whatsapp-metrics">
                ...
                <div class="sky-seo-metric-card total-clicks">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Total Clicks', 'sky360'); ?></h3>
                    ...
                    <div class="sky-seo-metric-subtitle"><?php esc_html_e('vs previous period', 'sky360'); ?></div>
                </div>
                
                <!-- Unique Users -->
                <div class="sky-seo-metric-card unique-users">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Unique Users', 'sky360'); ?></h3>
                        <div class="sky-seo-metric-icon">
                    ...
                    <div class="sky-seo-metric-subtitle"><?php esc_html_e('unique visitors', 'sky360'); ?></div>
                </div>
                
                <!-- Desktop Clicks -->
                <div class="sky-seo-metric-card desktop-clicks">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Desktop Clicks', 'sky360'); ?></h3>
                        <div class="sky-seo-metric-icon">
                    ...
                    <div class="sky-seo-metric-subtitle"><?php esc_html_e('of total clicks', 'sky360'); ?></div>
                </div>

                <!-- Mobile Clicks -->
                <div class="sky-seo-metric-card mobile-clicks">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Mobile Clicks', 'sky360'); ?></h3>
                        <div class="sky-seo-metric-icon">
                ...
                <div class="sky-seo-metric-card widget-clicks">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Widget Clicks', 'sky360'); ?></h3>
                        <div class="sky-seo-metric-icon">
                    ...
                    <div class="sky-seo-metric-value">0</div>
                    <div class="sky-seo-metric-percentage">0%</div>
                    <div class="sky-seo-metric-subtitle"><?php esc_html_e('floating widget', 'sky360'); ?></div>
                </div>
                
                <!-- Button Clicks -->
                <div class="sky-seo-metric-card button-clicks">
                    <div class="sky-seo-metric-header">
                        <h3 class="sky-seo-metric-title"><?php esc_html_e('Button Clicks', 'sky360'); ?></h3>
                        <div class="sky-seo-metric-icon">
                            <span class="dashicons dashicons-admin-links"></span>
                        </div>
                    </div>
                    <div class="sky-seo-metric-value">0</div>
                    <div class="sky-seo-metric-percentage">0%</div>
                    <div class="sky-seo-metric-subtitle"><?php esc_html_e('button links', 'sky360'); ?></div>
                </div>
            </div>
            ...
            <div class="sky-seo-heatmap-section">
                <div class="sky-seo-heatmap-header">
                    <h3 class="sky-seo-heatmap-title"><?php esc_html_e('Click Activity Heatmap', 'sky360'); ?></h3>
                    <p class="sky-seo-heatmap-subtitle"><?php esc_html_e('See when your users are most active', 'sky360'); ?></p>
                </div>
            ...
            <div class="sky-seo-conversations-section">
                <div class="sky-seo-conversations-header">
                    <h3 class="sky-seo-conversations-title"><?php esc_html_e('Page Performance', 'sky360'); ?></h3>
                    <div class="sky-seo-table-filters">
                        <div class="sky-seo-search-box">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="<?php esc_attr_e('Search pages...', 'sky360'); ?>">
                        </div>
                        <select class="sky-seo-filter-dropdown" data-filter="device">
                            <option value="all"><?php esc_html_e('All Devices', 'sky360'); ?></option>
                            <option value="mobile"><?php esc_html_e('Mobile', 'sky360'); ?></option>
                            <option value="desktop"><?php esc_html_e('Desktop', 'sky360'); ?></option>
                        </select>
                        <select class="sky-seo-filter-dropdown" data-filter="country">
                            <option value="all"><?php esc_html_e('All Countries', 'sky360'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <table class="sky-seo-conversations-table">
                    <thead>
                        <tr>
                            <th class="sortable" data-sort="page_title"><?php esc_html_e('Page Title', 'sky360'); ?></th>
                            <th class="sortable" data-sort="total_clicks"><?php esc_html_e('Total Clicks', 'sky360'); ?></th>
                            <th><?php esc_html_e('Widget', 'sky360'); ?></th>
                            <th><?php esc_html_e('Button', 'sky360'); ?></th>
                            <th><?php esc_html_e('Top City', 'sky360'); ?></th>
                            <th class="sortable" data-sort="last_click"><?php esc_html_e('Last Activity', 'sky360'); ?></th>
                            <th><?php esc_html_e('Actions', 'sky360'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Populated by JS -->
                ...
                <div class="sky-seo-table-pagination">
                    <div class="sky-seo-pagination-info">
                        <?php esc_html_e('Showing 0 pages', 'sky360'); ?>
                    </div>
                ...
                <div class="sky-seo-export-controls">
                    ...
                    <a href="#" class="sky-seo-export-button" data-format="excel">
                        ...
                        <?php esc_html_e('Export Excel', 'sky360'); ?>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div id="sky-whatsapp-details-modal" class="sky-modal" style="display: none;">
            <div class="sky-modal-content">
                <div class="sky-modal-header">
                    <h3 class="sky-modal-title"><?php esc_html_e('Page Details', 'sky360'); ?></h3>
    ...
    private function format_relative_time($timestamp) {
        ...
        if ($diff < 60) {
            return __('Just now', 'sky360');
        } elseif ($diff < 3600) {
            $mins = round($diff / 60);
            return sprintf(_n('%d minute ago', '%d minutes ago', $mins, 'sky360'), $mins);
        } elseif ($diff < 86400) {
            $hours = round($diff / 3600);
            return sprintf(_n('%d hour ago', '%d hours ago', $hours, 'sky360'), $hours);
        } elseif ($diff < 604800) {
            $days = round($diff / 86400);
            return sprintf(_n('%d day ago', '%d days ago', $days, 'sky360'), $days);
        } else {
    ...
    public function ajax_get_page_details() {
        ...
        if (empty($page_title) && empty($page_url)) {
            wp_send_json_error(['message' => __('Invalid page', 'sky360')]);
            return;
        }
        ...
        try {
            ...
            wp_send_json_error(['message' => __('Failed to load page details', 'sky360')]);
        }
    }
    ...
    public function ajax_export_data() {
        // Verify nonce
        if (!check_ajax_referer('sky_seo_whatsapp_nonce', 'nonce', false)) {
            wp_die(__('Security check failed', 'sky360'));
        }
        
        // Check permissions
        if (!current_user_can('manage_options')) {
            wp_die(__('Insufficient permissions', 'sky360'));
        }
    ...
    public function track_click() {
        ...
        try {
            ...
            wp_send_json_success([
                'message' => __('Click tracked successfully', 'sky360'),
                'id' => $insert_id
            ]);
            ...
            wp_send_json_error([
                'message' => __('Error tracking click', 'sky360'),
