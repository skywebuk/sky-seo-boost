...
function sky_seo_register_area_links_widget($widgets_manager) {
    ...
    class Sky_SEO_Area_Links_Widget extends \Elementor\Widget_Base {
        ...
        private function register_wpml_strings() {
            ...
            icl_register_string('sky-seo-boost', 'Widget Category: Sky SEO Boost', 'Sky SEO Boost');

            // Register widget title
            icl_register_string('sky-seo-boost', 'Widget: Sky SEO Location Links', 'Sky SEO Location Links');

            // Register all control labels
            icl_register_string('sky-seo-boost', 'Widget Label: Content', 'Content');
            icl_register_string('sky-seo-boost', 'Widget Label: Display Mode', 'Display Mode');
            icl_register_string('sky-seo-boost', 'Widget Option: Show All Pages in Category', 'Show All Pages in Category');
            icl_register_string('sky-seo-boost', 'Widget Option: Show Children of Specific Page', 'Show Children of Specific Page');
            icl_register_string('sky-seo-boost', 'Widget Label: Select Main Category', 'Select Main Category');
            icl_register_string('sky-seo-boost', 'Widget Label: Select Parent Page', 'Select Parent Page');
            icl_register_string('sky-seo-boost', 'Widget Label: Layout Style', 'Layout Style');
            icl_register_string('sky-seo-boost', 'Widget Option: Style 1 - Cards', 'Style 1 - Cards');
            icl_register_string('sky-seo-boost', 'Widget Option: Style 2 - List', 'Style 2 - List');
            icl_register_string('sky-seo-boost', 'Widget Label: Columns', 'Columns');
            icl_register_string('sky-seo-boost', 'Widget Label: Order By', 'Order By');
            icl_register_string('sky-seo-boost', 'Widget Option: Menu Order', 'Menu Order');
            icl_register_string('sky-seo-boost', 'Widget Option: Title', 'Title');
            icl_register_string('sky-seo-boost', 'Widget Option: Date', 'Date');
            icl_register_string('sky-seo-boost', 'Widget Label: Order', 'Order');
            icl_register_string('sky-seo-boost', 'Widget Option: Ascending', 'Ascending');
            icl_register_string('sky-seo-boost', 'Widget Option: Descending', 'Descending');
            icl_register_string('sky-seo-boost', 'Widget Label: View More Text', 'View More Text');
            icl_register_string('sky-seo-boost', 'Widget Default: View more', 'View more');

            // Register dropdown options
            icl_register_string('sky-seo-boost', 'Widget Dropdown: Select', '— Select —');
        }
        ...
        public function get_title() {
            return __('Sky SEO Location Links', 'sky-seo-boost');
        }
        ...
        private function get_main_categories() {
            ...
            if (post_type_exists('sky_areas')) {
                $categories['sky_areas'] = __('Areas We Cover', 'sky-seo-boost');
            }
            if (post_type_exists('sky_trending')) {
                $categories['sky_trending'] = __('Trending Searches', 'sky-seo-boost');
            }
            if (post_type_exists('sky_sectors')) {
                $categories['sky_sectors'] = __('Sectors', 'sky-seo-boost');
            }
        ...
        private function get_all_parent_pages() {
            $options = ['' => __('— Select —', 'sky-seo-boost')];
        ...
        protected function register_controls() {
            ...
            $this->start_controls_section(
                'content_section',
                [
                    'label' => __('Content', 'sky-seo-boost'),
            ...
            $this->add_control(
                'display_mode',
                [
                    'label' => __('Display Mode', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'category',
                    'options' => [
                        'category' => __('Show All Pages in Category', 'sky-seo-boost'),
                        'specific' => __('Show Children of Specific Page', 'sky-seo-boost'),
                    ],
                ]
            );
            ...
            $this->add_control(
                'main_category',
                [
                    'label' => __('Select Main Category', 'sky-seo-boost'),
            ...
            $this->add_control(
                'parent_page',
                [
                    'label' => __('Select Parent Page', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT2,
            ...
            $this->add_control(
                'layout_style',
                [
                    'label' => __('Layout Style', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'style1',
                    'options' => [
                        'style1' => __('Style 1 - Cards', 'sky-seo-boost'),
                        'style2' => __('Style 2 - List', 'sky-seo-boost'),
                    ],
                ]
            );
            ...
            $this->add_control(
                'columns',
                [
                    'label' => __('Columns', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => '3',
                    'options' => [
                        '1' => '1',
            ...
            $this->add_control(
                'order_by',
                [
                    'label' => __('Order By', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'title',
                    'options' => [
                        'menu_order' => __('Menu Order', 'sky-seo-boost'),
                        'title' => __('Title', 'sky-seo-boost'),
                        'date' => __('Date', 'sky-seo-boost'),
                    ],
                ]
            );
            ...
            $this->add_control(
                'order',
                [
                    'label' => __('Order', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'ASC',
                    'options' => [
                        'ASC' => __('Ascending', 'sky-seo-boost'),
                        'DESC' => __('Descending', 'sky-seo-boost'),
                    ],
                ]
            );
            ...
            $this->add_control(
                'view_more_text',
                [
                    'label' => __('View More Text', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'default' => __('View more', 'sky-seo-boost'),
                    'condition' => [
                        'layout_style' => 'style1',
                    ],
                ]
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => __('General', 'sky-seo-boost'),
            ...
            $this->add_responsive_control(
                'item_spacing',
                [
                    'label' => __('Item Spacing', 'sky-seo-boost'),
            ...
            $this->start_controls_section(
                'section_card_style',
                [
                    'label' => __('Card Style', 'sky-seo-boost'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'layout_style' => 'style1',
                    ],
            ...
            $this->add_control(
                'card_heading',
                [
                    'label' => __('Card Container', 'sky-seo-boost'),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __('Hover Box Shadow', 'sky-seo-boost'),
            ...
            $this->add_control(
                'initials_heading',
                [
                    'label' => __('Initials Box', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                'initials_size',
                [
                    'label' => __('Box Size', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::SLIDER,
                    'size_units' => ['px'],
                    'range' => [
                        'px' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => __('Typography & Colors', 'sky-seo-boost'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                ]
            );
            ...
            $this->start_controls_tab(
                'title_color_normal',
                ['label' => __('Normal', 'sky-seo-boost')]
            );
            
            $this->add_control(
                'title_color',
                [
                    'label' => __('Color', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'default' => '#D4A574',
                    'selectors' => [
            ...
            $this->add_control(
                'view_more_heading',
                [
                    'label' => __('View More Link', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'layout_style' => 'style1',
            ...
            $this->add_control(
                'list_heading',
                [
                    'label' => __('List Links', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'layout_style' => 'style2',
            ...
            $this->add_control(
                'list_hover_color',
                [
                    'label' => __('Hover Color', 'sky-seo-boost'),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'default' => '#D4A574',
                    'selectors' => [
...
add_action('elementor/elements/categories_registered', function($elements_manager) {
    $elements_manager->add_category(
        'sky-seo-boost',
        [
            'title' => __('Sky SEO Boost', 'sky-seo-boost'),
            'icon' => 'eicon-code',
        ]
    );
});