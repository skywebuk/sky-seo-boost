    ...
    <div class="wrap">
        ...
        <?php if (!class_exists('WooCommerce')) : ?>
            <div class="notice notice-warning">
                <p><?php _e('WooCommerce is required for conversion tracking features.', 'sky-seo-boost'); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div id="sky-utm-dashboard" class="sky-seo-utm-dashboard">
            ...
            <div class="sky-utm-builder">
                <h3>
                    ...
                    <?php _e('Create UTM Link', 'sky-seo-boost'); ?>
                </h3>
                
                <form id="sky-utm-builder-form" method="post">
                    <div class="sky-utm-form-grid">
                        <div class="sky-utm-form-group full-width">
                            <label for="utm-destination"><?php _e('Destination URL', 'sky-seo-boost'); ?> <span class="required">*</span></label>
                        ...
                        <div class="sky-utm-form-group">
                            <label for="utm-source"><?php _e('Campaign Source', 'sky-seo-boost'); ?> <span class="required">*</span></label>
                            <input type="text" id="utm-source" name="utm_source" placeholder="e.g., facebook, newsletter" required>
                        </div>
                        
                        <div class="sky-utm-form-group">
                            <label for="utm-medium"><?php _e('Campaign Medium', 'sky-seo-boost'); ?></label>
                            <input type="text" id="utm-medium" name="utm_medium" placeholder="e.g., social, email, cpc">
                        </div>
                        
                        <div class="sky-utm-form-group">
                            <label for="utm-campaign"><?php _e('Campaign Name', 'sky-seo-boost'); ?></label>
                            <input type="text" id="utm-campaign" name="utm_campaign" placeholder="e.g., summer_sale">
                        </div>
                        
                        <div class="sky-utm-form-group">
                            <label for="utm-term"><?php _e('Campaign Term', 'sky-seo-boost'); ?></label>
...
<div class="sky-utm-templates">
    <span><?php _e('Quick create:', 'sky-seo-boost'); ?></span>
    ...
    <button type="button" class="sky-utm-quick-create" data-template="google-cpc">
        ...
        Google Ads
            ...
            <div class="sky-utm-analytics-cards">
                ...
                <div class="sky-utm-metric-card">
                    <h4><?php _e('Avg Order Value', 'sky-seo-boost'); ?></h4>
            ...
            <div class="sky-utm-charts">
                <div class="sky-utm-chart-box">
                    <h4><?php _e('Click & Conversion Trends (Last 7 Days)', 'sky-seo-boost'); ?></h4>
                ...
                <div class="sky-utm-chart-box">
                    <h4><?php _e('Top Traffic Sources (Last 7 Days)', 'sky-seo-boost'); ?></h4>
                    <div class="sky-utm-chart-container">
                ...
                <div class="sky-utm-chart-box">
                    <h4><?php _e('Device Breakdown (Last 7 Days)', 'sky-seo-boost'); ?></h4>
                    <div class="sky-utm-chart-container">
            ...
            <div class="sky-utm-links-container">
                <div class="sky-utm-table-header">
                    <h3><?php _e('UTM Links', 'sky-seo-boost'); ?></h3>
                    
                    <div class="sky-utm-filters">
                        <select id="sky-utm-filter-source" class="sky-utm-filter">
                            <option value=""><?php _e('All Sources', 'sky-seo-boost'); ?></option>
                        </select>
                        
                        <select id="sky-utm-filter-campaign" class="sky-utm-filter">
                            <option value=""><?php _e('All Campaigns', 'sky-seo-boost'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <table id="sky-utm-links-table" class="wp-list-table widefat fixed striped">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="8" class="text-center"><?php _e('Loading...', 'sky-seo-boost'); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
