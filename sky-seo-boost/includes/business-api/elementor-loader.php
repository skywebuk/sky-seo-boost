...
class Sky_SEO_Elementor_Loader {
        ...
        if (file_exists($js_file)) {
            ...
            wp_localize_script('sky-elementor-script', 'skySeoElementor', [
                ...
                'i18n' => [
                    ...
                    'error' => __('An error occurred', 'sky-seo-boost'),
                    'noReviews' => __('No reviews found', 'sky-seo-boost'),
                    'readMore' => __('Read more', 'sky-seo-boost'),
                    'readLess' => __('Read less', 'sky-seo-boost')
                ]
            ]);
    ...
    public function add_widget_category($elements_manager) {
        $elements_manager->add_category('sky-seo-boost', [
