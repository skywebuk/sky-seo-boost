...
class Sky_SEO_Business_API {
    ...
    private function get_js_translations() {
        return [
            'closed_all_day' => esc_html__('Closed all day', 'sky-seo-boost'),
            'open_24_hours' => esc_html__('Open 24 hours', 'sky-seo-boost'),
            'hours_applied' => esc_html__('Hours applied to all days!', 'sky-seo-boost'),
            'hours_copied' => esc_html__('Hours copied successfully!', 'sky-seo-boost'),
            'copy_hours_from' => esc_html__('Copy Hours From', 'sky-seo-boost'),
            'select_source_day' => esc_html__('Select source day', 'sky-seo-boost'),
            'copy_to' => esc_html__('Copy to', 'sky-seo-boost'),
            'cancel' => esc_html__('Cancel', 'sky-seo-boost'),
            'apply' => esc_html__('Apply', 'sky-seo-boost'),
            'fetch_confirm' => esc_html__('This will check for new reviews. Continue?', 'sky-seo-boost')
        ];
    }
    ...
    public function add_admin_menu() {
        add_submenu_page(
            'sky-seo-boost',
            __('Business API Settings', 'sky-seo-boost'),
            __('Business API', 'sky-seo-boost'),
            'manage_options',
