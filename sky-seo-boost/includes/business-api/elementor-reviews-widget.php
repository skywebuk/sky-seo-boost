...
class Sky_SEO_Reviews_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Business Reviews', 'sky360');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Reviews Settings', 'sky360'),
        ...
        $this->add_control(
            'sky_reviews_layout',
            [
                'label' => __('Layout', 'sky360'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'slider', // UPDATED DEFAULT
                'options' => [
                    'slider' => __('Slider', 'sky360'),
                    'grid' => __('Grid', 'sky360'),
                ],
            ]
        );
        ...
        $this->add_control(
            'sky_platform_filter',
            [
                'label' => __('Platform Filter', 'sky360'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'all', // UPDATED DEFAULT
                'options' => [
                    'all' => __('All Platforms', 'sky360'),
                    'google' => __('Google Only', 'sky360'),
                    'facebook' => __('Facebook Only', 'sky360'),
                    'trustpilot' => __('Trustpilot Only', 'sky360'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show All Reviews', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
                'description' => __('Enable to show all available reviews. When disabled, limits reviews based on "Number of Reviews" setting.', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            'sky_reviews_count',
            [
                'label' => __('Number of Reviews', 'sky360'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Randomize Reviews', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
                'description' => __('Show reviews in random order on each page load', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Hide Empty Reviews', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no', // UPDATED DEFAULT
                'description' => __('Hide reviews that have no text content', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            'sky_show_likes',
            [
                'label' => __('Show Like Button', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
                'description' => __('Show like button with count on each review', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            'sky_grid_columns',
            [
                'label' => __('Grid Columns', 'sky360'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '3',
                'options' => [
                    '1' => __('1 Column', 'sky360'),
                    '2' => __('2 Columns', 'sky360'),
                    '3' => __('3 Columns', 'sky360'),
                    '4' => __('4 Columns', 'sky360'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'sky_show_load_more',
            [
                'label' => __('Show Load More Button', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no',
                'condition' => [
                    'sky_reviews_layout' => 'grid',
        ...
        $this->add_control(
            'sky_load_more_text',
            [
                'label' => __('Load More Text', 'sky360'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Load More', 'sky360'),
                'condition' => [
                    'sky_reviews_layout' => 'grid',
        ...
        $this->add_control(
            'sky_min_rating',
            [
                'label' => __('Minimum Rating', 'sky360'),
                'type' => \Elementor\Controls_Manager::NUMBER,
        ...
        $this->add_control(
            'sky_text_lines',
            [
                'label' => __('Text Lines Before Truncate', 'sky360'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => 5, // UPDATED DEFAULT
                'min' => 2,
                'max' => 10,
                'description' => __('Number of lines to show before "Read more" appears', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            'sky_dark_mode',
            [
                'label' => __('Dark Mode', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no', // DEFAULT TO OFF (LIGHT MODE)
                'description' => __('Enable dark mode for reviews (dark background, light text)', 'sky360'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Slides per view', 'sky360'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => 3, // UPDATED DEFAULT
                'min' => 1,
                'max' => 6,
                'step' => 0.1,
                'description' => __('Set numbers of slides you want to display at the same time on slider\'s container for carousel mode.', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Scroll per page', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no', // UPDATED DEFAULT
                'description' => __('Scroll per page not per item. This affects next/prev buttons and mouse/touch dragging.', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            'sky_slider_autoplay',
            [
                'label' => __('Slider autoplay', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Autoplay delay (ms)', 'sky360'),
                'type' => \Elementor\Controls_Manager::NUMBER,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Init carousel on scroll', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no', // UPDATED DEFAULT
                'description' => __('This option allows you to init carousel script only when visitor scroll the page to the slider. Useful for performance optimization.', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Disabled overflow', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'no', // UPDATED DEFAULT
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Center Mode', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
                'description' => __('Center the active slide', 'sky360'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Review Us Button', 'sky360'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes', // UPDATED DEFAULT
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Review Button Text', 'sky360'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Review Us', 'sky360'), // UPDATED DEFAULT
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Icon Position', 'sky360'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'before', // UPDATED DEFAULT
                'options' => [
                    'before' => __('Before Text', 'sky360'),
                    'after' => __('After Text', 'sky360'),
                ],
                'condition' => [
                    'sky_show_review_button' => 'yes',
        ...
        $this->start_controls_section(
            'sky_modal_section',
            [
                'label' => __('Modal Settings', 'sky360'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Modal Text Typography', 'sky360'),
        ...
        $this->add_control(
            'sky_review_spacing',
            [
                'label' => __('Review Spacing', 'sky360'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'sky_review_padding',
            [
                'label' => __('Review Padding', 'sky360'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Review Background', 'sky360'),
                'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Author Typography', 'sky360'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Review Text Typography', 'sky360'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Review Text Color', 'sky360'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#202124', // LIGHT MODE DEFAULT
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Time Typography', 'sky360'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Read More Style', 'sky360'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'sky_read_more_color',
            [
                'label' => __('Read More Color', 'sky360'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#5F6368', // LIGHT MODE DEFAULT
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Read More Hover Color', 'sky360'),
                'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Review Button Style', 'sky360'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'sky_reviews_layout' => 'slider',
                    'sky_show_review_button' => 'yes',
    ...
    protected function render() {
        ...
        if (!class_exists('Sky_SEO_Business_API') && !class_exists('Sky_SEO_Reviews_Database')) {
            if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
                ...
                echo __('Business API is not available. Please ensure the Sky SEO Boost plugin is properly configured.', 'sky360');
                echo '</div>';
            }
            return;
        }
        ...
        if (!$data || empty($data['reviews'])) {
            if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
                ...
                echo __('No reviews available. You can add manual reviews in the Business API settings or fetch Google reviews if you have a Place ID configured.', 'sky360');
                echo '</div>';
            } else {
                ...
                echo '<p>' . esc_html__('Be the first to leave a review!', 'sky360') . '</p>';
        ...
        if (empty($reviews)) {
            echo '<p>' . esc_html__('No reviews match the current filter criteria', 'sky360') . '</p>';
            return;
        }
        ...
        <div class="sky-review-item" data-review-id="<?php echo esc_attr($unique_review_id); ?>">
            <div class="sky-review-content">
                ...
                <div class="sky-review-rating">
                    ...
                    <span class="sky-verified-review" title="<?php esc_attr_e('Verified Google Review', 'sky360'); ?>">
                ...
                <?php else : ?>
                    <div class="sky-review-text"><?php esc_html_e('No review text provided', 'sky360'); ?></div>
                <?php endif; ?>
            </div>
            <div class="sky-review-footer">
                <button class="sky-read-more-toggle" 
                    ...
                    <?php esc_html_e('READ MORE', 'sky360'); ?>
                </button>
