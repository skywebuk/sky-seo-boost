...
class Sky_SEO_Business_Info_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Business Hours & Info', 'sky-seo-boost');
    }
    ...
    private function register_content_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Display Options', 'sky-seo-boost'),
        ...
        $this->add_control(
            'display_type',
            [
                'label' => __('Display Type', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'status',
                'options' => [
                    'status' => __('Open/Closed Status', 'sky-seo-boost'),
                    'hours_today' => __('Today\'s Hours', 'sky-seo-boost'),
                    'hours_week' => __('Weekly Schedule', 'sky-seo-boost'),
                    'rating' => __('Star Rating', 'sky-seo-boost'),
                ],
            ]
        );
        ...
        $this->add_control(
            'status_heading',
            [
                'label' => __('Status Options', 'sky-seo-boost'),
        ...
        $this->add_control(
            'open_text',
            [
                'label' => __('Open Text', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Shop open now', 'sky-seo-boost'),
                'condition' => [
                    'display_type' => 'status',
                ],
            ]
        ...
        $this->add_control(
            'closed_text',
            [
                'label' => __('Closed Text', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Closed', 'sky-seo-boost'),
                'condition' => [
                    'display_type' => 'status',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Hours Details Below', 'sky-seo-boost'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Rating with Status', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'display_type' => 'status',
        ...
        $this->add_control(
            'today_label',
            [
                'label' => __('Label', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __("Today's Hours", 'sky-seo-boost'),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Business Hours', 'sky-seo-boost'),
                'condition' => [
        ...
        $this->add_control(
            'show_week_title',
            [
                'label' => __('Show Title', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'display_type' => 'hours_week',
        ...
        $this->add_control(
            'highlight_today',
            [
                'label' => __('Highlight Today', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'display_type' => 'hours_week',
        ...
        $this->add_control(
            'rating_heading',
            [
                'label' => __('Rating Options', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'display_type' => 'rating',
        ...
        $this->add_control(
            'show_rating_value',
            [
                'label' => __('Show Numeric Rating', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'display_type' => 'rating',
        ...
        $this->add_control(
            'show_review_count',
            [
                'label' => __('Show Review Count', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'conditions' => [
                    'relation' => 'or',
        ...
        $this->add_control(
            'enable_schema',
            [
                'label' => __('Enable Schema Markup', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'yes',
                'separator' => 'before',
                'description' => __('Add structured data for better SEO', 'sky-seo-boost'),
            ]
        );
    ...
    private function register_style_controls() {
        ...
        $this->start_controls_section(
            'style_general',
            [
                'label' => __('General Style', 'sky-seo-boost'),
        ...
        $this->add_responsive_control(
            'text_align',
            [
                'label' => __('Alignment', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'sky-seo-boost'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'sky-seo-boost'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'sky-seo-boost'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'sky-seo-boost'),
    ...
    private function register_status_style_controls() {
        $this->start_controls_section(
            'style_status',
            [
                'label' => __('Status Badge Style', 'sky-seo-boost'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'display_type' => 'status',
                ],
        ...
        $this->add_control(
            'badge_layout',
            [
                'label' => __('Badge Layout', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'inline',
                'options' => [
                    'inline' => __('Inline', 'sky-seo-boost'),
                    'stacked' => __('Stacked', 'sky-seo-boost'),
                ],
            ]
        );
        ...
        $this->add_control(
            'open_state_heading',
            [
                'label' => __('Open State', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Closed State', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    private function register_hours_style_controls() {
        $this->start_controls_section(
            'style_hours',
            [
                'label' => __('Hours Style', 'sky-seo-boost'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Label Typography', 'sky-seo-boost'),
        ...
        $this->add_control(
            'hours_label_color',
            [
                'label' => __('Label Color', 'sky-seo-boost'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#333333',
                'selectors' => [
    ...
    private function register_rating_style_controls() {
        $this->start_controls_section(
            'style_rating',
            [
                'label' => __('Rating Style', 'sky-seo-boost'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
    ...
    protected function render() {
        ...
        if (!class_exists('Sky_SEO_Business_API') && !class_exists('Sky_SEO_Reviews_Database')) {
            if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
                ...
                echo esc_html__('Business API is not available. Please ensure the Sky SEO Boost plugin is properly configured.', 'sky-seo-boost');
                echo '</div>';
            }
            return;
        }
    ...
    private function render_schema_markup($data) {
        ...
        if (isset($data['opening_hours']) && is_array($data['opening_hours'])) {
            foreach ($data['opening_hours'] as $day => $hours) {
                if ($hours !== 'Closed' && $hours !== __('Closed', 'sky-seo-boost')) {
                    $day_abbr = substr($day, 0, 2);
                    if ($hours === '24 hours' || $hours === __('24 hours', 'sky-seo-boost')) {
    ...
    private function render_status($settings) {
        ...
        <div class="sky-seo-business-status sky-seo-status-<?php echo esc_attr($status['class']); ?> <?php echo esc_attr($layout_class); ?>">
            ...
            <?php if ($settings['show_rating_with_status'] === 'yes' && $data && isset($data['rating']) && $data['rating'] > 0) : ?>
                ...
                <span class="sky-seo-rating-stars" role="img" aria-label="<?php echo esc_attr(sprintf(__('%s out of 5 stars', 'sky-seo-boost'), number_format($data['rating'], 1))); ?>">
            ...
            <?php if ($settings['show_hours_with_status'] === 'yes' && $data && isset($data['opening_hours'])) : ?>
                <span class="sky-seo-status-text">
                    ...
                    $today_hours = isset($data['opening_hours'][$current_day]) ? $data['opening_hours'][$current_day] : __('Hours not available', 'sky-seo-boost');
    ...
    private function render_hours_today($settings) {
        $data = $this->get_business_data();
        $status = $this->get_current_status();
        $today_hours = __('Closed', 'sky-seo-boost');
        
        if ($data && isset($data['opening_hours'])) {
            $current_day = $status['current_day'];
            $today_hours = isset($data['opening_hours'][$current_day]) ? $data['opening_hours'][$current_day] : __('Closed', 'sky-seo-boost');
        }
    ...
    private function render_hours_week($settings) {
        ...
        <div class="sky-seo-hours-week">
            ...
            <table class="sky-seo-hours-table" role="table">
                <caption class="screen-reader-text"><?php esc_html_e('Business opening hours by day', 'sky-seo-boost'); ?></caption>
                <tbody>
                <?php foreach ($days as $day_key => $day_label) : ?>
                    <tr class="<?php echo ($settings['highlight_today'] === 'yes' && $day_key == $current_day) ? 'sky-seo-today' : ''; ?>">
                        ...
                        <td class="sky-seo-hours">
                            <?php 
                            $hours = isset($weekly_hours[$day_key]) ? $weekly_hours[$day_key] : __('Closed', 'sky-seo-boost');
                            echo esc_html($hours); 
                            ?>
                        </td>
                    </tr>
    ...
    private function render_rating($settings) {
        ...
        if (!$data || !isset($data['rating']) || $data['rating'] == 0) {
            if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
                ...
                echo esc_html__('No rating data available. Please configure the Business API.', 'sky-seo-boost');
                echo '</div>';
            }
            return;
        }
        ...
        <div class="sky-seo-rating <?php echo esc_attr($layout_class); ?>">
            ...
            <?php if ($settings['show_review_count'] === 'yes' && isset($data['total_reviews']) && $data['total_reviews'] > 0) : ?>
                <span class="sky-seo-rating-count">
                    (<?php echo number_format($data['total_reviews']); ?> <?php echo esc_html(_n('review', 'reviews', $data['total_reviews'], 'sky-seo-boost')); ?>)
                </span>
            <?php endif; ?>
        </div>
        <?php
