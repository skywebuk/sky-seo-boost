        ...
        if (!empty($post_ids)) {
            switch ($action) {
                ...
                case 'delete':
                    ...
                    echo '<div class="notice notice-success is-dismissible"><p>' . esc_html__('Selected posts deleted.', 'sky-seo-boost') . '</p></div>';
                    break;
            }
        }
    }
            ...
            <form method="get" class="sky-seo-filters-form">
                ...
                <div class="sky-seo-filter-row">
                    <div class="sky-seo-filter-group">
                        <label for="search"><?php _e('Search', 'sky-seo-boost'); ?></label>
                        <input type="text" name="search" id="search" placeholder="<?php _e('Search by title...', 'sky-seo-boost'); ?>" value="<?php echo esc_attr($search_term); ?>">
                    </div>
                    
                    <div class="sky-seo-filter-group">
                        <label for="post_type_filter"><?php _e('Post Type', 'sky-seo-boost'); ?></label>
                        <select name="post_type_filter" id="post_type_filter">
                            <option value="all" <?php selected($selected_post_type, 'all'); ?>><?php _e('All Post Types', 'sky-seo-boost'); ?></option>
                    ...
                    <div class="sky-seo-filter-group">
                        ...
                        <div class="sky-seo-date-range">
                            <input type="date" name="start_date" id="start_date" value="<?php echo esc_attr($start_date); ?>" placeholder="<?php _e('Start', 'sky-seo-boost'); ?>">
                            <span class="sky-seo-date-separator">—</span>
                            <input type="date" name="end_date" id="end_date" value="<?php echo esc_attr($end_date); ?>" placeholder="<?php _e('End', 'sky-seo-boost'); ?>">
                        </div>
                    </div>
                    
                    <div class="sky-seo-filter-actions">
                        <button type="submit" class="button"><?php _e('Apply Filters', 'sky-seo-boost'); ?></button>
                        <a href="?page=sky-seo-all-content" class="button button-link"><?php _e('Clear', 'sky-seo-boost'); ?></a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="sky-seo-bulk-actions-bar">
                <div class="alignleft actions">
                    <select name="action" class="sky-seo-bulk-select">
                        ...
                        <option value="delete"><?php _e('Delete', 'sky-seo-boost'); ?></option>
                    </select>
                ...
                <table class="sky-seo-content-table">
                    <thead>
                        <tr>
                            ...
                            <th class="column-title"><?php esc_html_e('Title', 'sky-seo-boost'); ?></th>
                            <th class="column-type"><?php esc_html_e('Type', 'sky-seo-boost'); ?></th>
                            <th class="column-clicks">
                                <span class="dashicons dashicons-chart-bar"></span>
                                <?php esc_html_e('Total Clicks', 'sky-seo-boost'); ?>
                            </th>
                            <th class="column-traffic"><?php esc_html_e('Traffic Sources', 'sky-seo-boost'); ?></th>
                            <th class="column-status"><?php esc_html_e('Status', 'sky-seo-boost'); ?></th>
                            <th class="column-date"><?php esc_html_e('Date', 'sky-seo-boost'); ?></th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td class="column-title">
                                    ...
                                    <div class="row-actions">
                                        <span class="edit">
                                            <a href="<?php echo esc_url(get_edit_post_link()); ?>"><?php _e('Edit', 'sky-seo-boost'); ?></a> | 
                                        </span>
                                        <span class="view">
                                            <a href="<?php echo esc_url(get_permalink()); ?>" target="_blank"><?php _e('View', 'sky-seo-boost'); ?></a> | 
                                        </span>
                                        <span class="trash">
                                            <a href="<?php echo esc_url(get_delete_post_link($post_id)); ?>" class="submitdelete"><?php _e('Trash', 'sky-seo-boost'); ?></a>
                                        </span>
                                    </div>
                                </td>
                                <td class="column-type">
                                    ...
                                    $type_labels = [
                                        'sky_areas' => ['label' => __('Area', 'sky-seo-boost'), 'icon' => 'location-alt'],
                                        'sky_trending' => ['label' => __('Trending', 'sky-seo-boost'), 'icon' => 'trending-up'],
                                        'sky_sectors' => ['label' => __('Sector', 'sky-seo-boost'), 'icon' => 'building']
                                    ];
                            ...
                            <tr>
                                <td colspan="7" class="no-items">
                                    <div class="sky-seo-no-content">
                                        ...
                                        <p><?php esc_html_e('No content found.', 'sky-seo-boost'); ?></p>
                                        <?php if (!empty($search_term) || $selected_post_type !== 'all' || !empty($start_date)) : ?>
                                            <p class="description"><?php _e('Try adjusting your filters or', 'sky-seo-boost'); ?> 
                                                <a href="?page=sky-seo-all-content"><?php _e('clear all filters', 'sky-seo-boost'); ?></a>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </td>
