...
function sky_seo_two_step_render_settings($active_tab) {
    ...
    if (!class_exists('Sky_SEO_Two_Step_Core')) {
        echo '<div class="notice notice-error"><p>' . __('Two-step verification system is not properly loaded. Please contact support.', 'sky-seo-boost') . '</p></div>';
        return;
    }
    ...
    <div class="sky-seo-two-step-settings">
        ...
        <div class="sky-seo-card">
            ...
            <form method="post" action="">
                ...
                <?php submit_button(__('Save Two-Step Settings', 'sky-seo-boost')); ?>
            </form>
        </div>
...
function sky_seo_two_step_save_settings() {
    ...
    try {
        ...
        add_settings_error(
            ...
            __('Two-step verification settings saved successfully.', 'sky-seo-boost'),
            'success'
        );
    } catch (Exception $e) {
        ...
        add_settings_error(
            ...
            __('Error saving two-step verification settings. Please try again.', 'sky-seo-boost'),
            'error'
        );
    }
}
