    ...
    <div class="sky-seo-analytics-wrap">
        <form method="post" action="options.php">
            ...
            <div class="sky-seo-tracking-card">
                <div class="sky-seo-tracking-header">
                    <div class="sky-seo-tracking-title">
                        ...
                        <h3><?php _e('Google Analytics', 'sky-seo-boost'); ?></h3>
                    </div>
                    <div class="sky-seo-detection-status">
                        <span class="sky-seo-status-label"><?php _e('Current Detection Status:', 'sky-seo-boost'); ?></span>
                        <span class="sky-seo-status-indicator <?php echo $results['analytics']['detected'] ? 'detected' : 'not-detected'; ?>">
                            <?php echo $results['analytics']['detected'] ? __('Detected', 'sky-seo-boost') : __('Not Detected', 'sky-seo-boost'); ?>
                        </span>
                    </div>
                </div>
                <div class="sky-seo-tracking-body">
                    <div class="sky-seo-field-group">
                        <label for="ga_measurement_id"><?php _e('Measurement ID', 'sky-seo-boost'); ?></label>
                        ...
                        <p class="description"><?php _e('Enter your Google Analytics 4 Measurement ID', 'sky-seo-boost'); ?></p>
                    </div>
                    <div class="sky-seo-field-group">
                        <label class="sky-seo-checkbox-label">
                            ...
                            <?php _e('Enable Google Analytics tracking', 'sky-seo-boost'); ?>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="sky-seo-tracking-card">
                <div class="sky-seo-tracking-header">
                    <div class="sky-seo-tracking-title">
                        ...
                        <h3><?php _e('Google Ads', 'sky-seo-boost'); ?></h3>
                    </div>
                    <div class="sky-seo-detection-status">
                        <span class="sky-seo-status-label"><?php _e('Current Detection Status:', 'sky-seo-boost'); ?></span>
                        <span class="sky-seo-status-indicator <?php echo $results['ads']['detected'] ? 'detected' : 'not-detected'; ?>">
                            <?php echo $results['ads']['detected'] ? __('Detected', 'sky-seo-boost') : __('Not Detected', 'sky-seo-boost'); ?>
                        </span>
                    </div>
                </div>
                <div class="sky-seo-tracking-body">
                    <div class="sky-seo-field-group">
                        <label for="google_ads_conversion_id"><?php _e('Conversion ID', 'sky-seo-boost'); ?></label>
                        ...
                        <p class="description"><?php _e('Enter your Google Ads Conversion ID', 'sky-seo-boost'); ?></p>
                    </div>
                    
                    <!-- NEW: Conversion Type Dropdown -->
                    <div class="sky-seo-field-group">
                        <label for="google_ads_conversion_type"><?php _e('Conversion Type', 'sky-seo-boost'); ?></label>
                        <select name="sky_seo_settings[google_ads_conversion_type]" id="google_ads_conversion_type" class="regular-text">
                            <option value="woocommerce" <?php selected(isset($settings['google_ads_conversion_type']) ? $settings['google_ads_conversion_type'] : 'woocommerce', 'woocommerce'); ?>>
                                <?php _e('WooCommerce Purchase', 'sky-seo-boost'); ?>
                            </option>
                            <option value="form_submission" <?php selected(isset($settings['google_ads_conversion_type']) ? $settings['google_ads_conversion_type'] : '', 'form_submission'); ?>>
                                <?php _e('Form Submission (Thank You Page)', 'sky-seo-boost'); ?>
                            </option>
                            <option value="custom" <?php selected(isset($settings['google_ads_conversion_type']) ? $settings['google_ads_conversion_type'] : '', 'custom'); ?>>
                                <?php _e('Custom Event', 'sky-seo-boost'); ?>
                            </option>
                        </select>
                        <p class="description"><?php _e('Select the type of conversion you want to track', 'sky-seo-boost'); ?></p>
                    </div>
                    
                    <!-- Conversion Label (shows for all types) -->
                    <div class="sky-seo-field-group">
                        <label for="google_ads_conversion_label"><?php _e('Conversion Label', 'sky-seo-boost'); ?></label>
                        ...
                        <p class="description">
                            <?php _e('Enter ONLY the conversion label (the part after the slash).', 'sky-seo-boost'); ?><br>
                            <strong><?php _e('Example:', 'sky-seo-boost'); ?></strong> <?php _e('If Google Ads shows', 'sky-seo-boost'); ?> <code>AW-820746807/AQsOCIO1ou8aELe0rocD</code>, <?php _e('enter only', 'sky-seo-boost'); ?> <code>AQsOCIO1ou8aELe0rocD</code>
                        </p>
                    </div>
                    ...
                    <div class="sky-seo-field-group" id="thank_you_page_field" style="<?php echo (isset($settings['google_ads_conversion_type']) && $settings['google_ads_conversion_type'] === 'form_submission') ? '' : 'display:none;'; ?>">
                        <label for="google_ads_thank_you_page"><?php _e('Thank You Page', 'sky-seo-boost'); ?></label>
                        <?php
                        ...
                        <select name="sky_seo_settings[google_ads_thank_you_page_id]" id="google_ads_thank_you_page_id" class="regular-text">
                            <option value=""><?php _e('— Select Thank You Page —', 'sky-seo-boost'); ?></option>
                            <?php
                        ...
                        <p class="description"><?php _e('Select the thank you page where users are redirected after form submission', 'sky-seo-boost'); ?></p>
                        ...
                        <div style="margin-top: 10px;">
                            <label>
                                ...
                                <?php _e('Use custom URL instead', 'sky-seo-boost'); ?>
                            </label>
                            <div id="custom_thank_you_url_field" style="margin-top: 5px; <?php echo empty($settings['google_ads_custom_thank_you_url']) ? 'display:none;' : ''; ?>">
                                ...
                                <p class="description"><?php _e('Enter custom URL path (e.g., /thank-you)', 'sky-seo-boost'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sky-seo-field-group" id="conversion_value_field" style="<?php echo (isset($settings['google_ads_conversion_type']) && $settings['google_ads_conversion_type'] === 'woocommerce') ? 'display:none;' : ''; ?>">
                        <label for="google_ads_conversion_value"><?php _e('Conversion Value', 'sky-seo-boost'); ?> <span class="description">(<?php _e('Optional', 'sky-seo-boost'); ?>)</span></label>
                        ...
                        <p class="description"><?php _e('Fixed conversion value (leave empty for dynamic WooCommerce values)', 'sky-seo-boost'); ?></p>
                    </div>
                    ...
                    <div class="sky-seo-field-group">
                        <label><?php _e('Test Configuration', 'sky-seo-boost'); ?></label>
                        <div>
                            <button type="button" id="test-google-ads" class="button button-secondary">
                                <?php _e('Test Google Ads Code', 'sky-seo-boost'); ?>
                            </button>
                            <p class="description"><?php _e('Verify your Google Ads configuration is working correctly', 'sky-seo-boost'); ?></p>
            ...
            <div class="sky-seo-tracking-card">
                <div class="sky-seo-tracking-header">
                    <div class="sky-seo-tracking-title">
                        ...
                        <h3><?php _e('Google Tag Manager', 'sky-seo-boost'); ?></h3>
                    </div>
                    <div class="sky-seo-detection-status">
                        <span class="sky-seo-status-label"><?php _e('Current Detection Status:', 'sky-seo-boost'); ?></span>
                        <span class="sky-seo-status-indicator <?php echo $results['gtm']['detected'] ? 'detected' : 'not-detected'; ?>">
                            <?php echo $results['gtm']['detected'] ? __('Detected', 'sky-seo-boost') : __('Not Detected', 'sky-seo-boost'); ?>
                        </span>
                    </div>
                </div>
                <div class="sky-seo-tracking-body">
                    <div class="sky-seo-field-group">
                        <label for="gtm_container_id"><?php _e('Container ID', 'sky-seo-boost'); ?></label>
                        ...
                        <p class="description"><?php _e('Enter your Google Tag Manager Container ID', 'sky-seo-boost'); ?></p>
                    </div>
                    <div class="sky-seo-field-group">
                        <label class="sky-seo-checkbox-label">
                            ...
                            <?php _e('Enable Google Tag Manager', 'sky-seo-boost'); ?>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="sky-seo-tracking-card">
                <div class="sky-seo-tracking-header">
                    <div class="sky-seo-tracking-title">
                        ...
                        <h3><?php _e('Meta Pixel (Facebook)', 'sky-seo-boost'); ?></h3>
                    </div>
                    <div class="sky-seo-detection-status">
                        <span class="sky-seo-status-label"><?php _e('Current Detection Status:', 'sky-seo-boost'); ?></span>
                        <span class="sky-seo-status-indicator <?php echo $results['facebook_pixel']['detected'] ? 'detected' : 'not-detected'; ?>">
                            <?php echo $results['facebook_pixel']['detected'] ? __('Detected', 'sky-seo-boost') : __('Not Detected', 'sky-seo-boost'); ?>
                        </span>
                    </div>
                </div>
                <div class="sky-seo-tracking-body">
                    <div class="sky-seo-field-group">
                        <label for="meta_pixel_id"><?php _e('Pixel ID', 'sky-seo-boost'); ?></label>
                        ...
                        <p class="description"><?php _e('Enter your Meta Pixel ID', 'sky-seo-boost'); ?></p>
                    </div>
                    <div class="sky-seo-field-group">
                        <label class="sky-seo-checkbox-label">
                            ...
                            <?php _e('Enable Meta Pixel tracking', 'sky-seo-boost'); ?>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="sky-seo-tracking-card">
                <div class="sky-seo-tracking-header">
                    <div class="sky-seo-tracking-title">
                        <h3><?php _e('Test Mode & Actions', 'sky-seo-boost'); ?></h3>
                    </div>
                </div>
                <div class="sky-seo-tracking-body">
                    <div class="sky-seo-field-group">
                        <p class="description"><?php _e('Enable test mode to show tracking codes only to administrators. This helps you verify tracking codes are working correctly before going live.', 'sky-seo-boost'); ?></p>
                        <label class="sky-seo-checkbox-label">
                            ...
                            <?php _e('Enable Test Mode', 'sky-seo-boost'); ?>
                        </label>
                    </div>
                    <div class="sky-seo-actions">
                        <?php submit_button(__('Save Tracking Settings', 'sky-seo-boost'), 'primary', 'submit', false); ?>
                        <a href="?page=sky-seo-settings&tab=tracking&refresh=1" class="button button-secondary"><?php _e('Refresh Detection Status', 'sky-seo-boost'); ?></a>
                    </div>
                </div>
            </div>
        </form>
