...
define('SKY_SEO_BOOST_VERSION', '4.5.0');
...
class Sky_SEO_Boost {
    ...
    public function show_unlicensed_notice() {
        ...
        <div class="notice notice-error">
            <p>
                <strong><?php _e('Sky SEO Boost:', 'sky-seo-boost'); ?></strong>
                <?php _e('This plugin requires a valid license to function. All features are currently disabled.', 'sky-seo-boost'); ?>
    ...
    public function register_post_types() {
        try {
            ...
            $area_labels = [
                'name' => _x('Areas We Cover', 'Post Type General Name', 'sky-seo-boost'),
                'singular_name' => _x('Area', 'Post Type Singular Name', 'sky-seo-boost'),
                'menu_name' => __('Areas We Cover', 'sky-seo-boost'),
                'name_admin_bar' => __('Area', 'sky-seo-boost'),
                'add_new' => __('Add New', 'sky-seo-boost'),
                'add_new_item' => __('Add New Area', 'sky-seo-boost'),
                'edit_item' => __('Edit Area', 'sky-seo-boost'),
                'view_item' => __('View Area', 'sky-seo-boost'),
                'all_items' => __('Areas', 'sky-seo-boost'),
                'search_items' => __('Search Areas', 'sky-seo-boost'),
            ];
            ...
            $trending_labels = [
                'name' => _x('Trending Searches', 'Post Type General Name', 'sky-seo-boost'),
                'singular_name' => _x('Trending Search', 'Post Type Singular Name', 'sky-seo-boost'),
                'menu_name' => __('Trending Searches', 'sky-seo-boost'),
                'name_admin_bar' => __('Trending Search', 'sky-seo-boost'),
                'add_new' => __('Add New', 'sky-seo-boost'),
                'add_new_item' => __('Add New Trending Search', 'sky-seo-boost'),
                'edit_item' => __('Edit Trending Search', 'sky-seo-boost'),
                'view_item' => __('View Trending Search', 'sky-seo-boost'),
                'all_items' => __('Trending Searches', 'sky-seo-boost'),
                'search_items' => __('Search Trending', 'sky-seo-boost'),
            ];
            ...
            // Sectors Post Type
            $sectors_labels = [
                'name' => _x('Sectors', 'Post Type General Name', 'sky-seo-boost'),
                'singular_name' => _x('Sector', 'Post Type Singular Name', 'sky-seo-boost'),
                'menu_name' => __('Sectors', 'sky-seo-boost'),
                'name_admin_bar' => __('Sector', 'sky-seo-boost'),
                'add_new' => __('Add New', 'sky-seo-boost'),
                'add_new_item' => __('Add New Sector', 'sky-seo-boost'),
                'edit_item' => __('Edit Sector', 'sky-seo-boost'),
                'view_item' => __('View Sector', 'sky-seo-boost'),
                'all_items' => __('Sectors', 'sky-seo-boost'),
                'search_items' => __('Search Sectors', 'sky-seo-boost'),
            ];
    ...
    public function add_admin_menu() {
        // Main Sky SEO Boost Menu - always show for license access
        add_menu_page(
            __('Sky SEO Boost', 'sky-seo-boost'),
            __('Sky SEO Boost', 'sky-seo-boost'),
            'edit_pages',
            'sky-seo-boost',
        ...
        if ($this->license_valid) {
            ...
            add_submenu_page(
                'sky-seo-boost',
                __('Areas We Cover', 'sky-seo-boost'),
                __('Areas', 'sky-seo-boost'),
                'edit_pages',
            ...
            add_submenu_page(
                'sky-seo-boost',
                __('Trending Searches', 'sky-seo-boost'),
                __('Trending Searches', 'sky-seo-boost'),
                'edit_pages',
    ...
    public function show_license_required_page() {
        ?>
        <div class="wrap">
            <h1><?php _e('Sky SEO Boost', 'sky-seo-boost'); ?></h1>
            <div class="notice notice-error">
                <p>
                    <strong><?php _e('License Required', 'sky-seo-boost'); ?></strong><br>
                    <?php _e('This plugin requires a valid license to function. Please activate your license to unlock all features.', 'sky-seo-boost'); ?>
                </p>
                <p>
                    <a href="<?php echo admin_url('admin.php?page=sky-seo-settings&tab=license'); ?>" class="button button-primary">
                        <?php _e('Activate License', 'sky-seo-boost'); ?>
                    </a>
                </p>
            </div>
    ...
    public function show_activation_notice() {
        ...
        <div class="notice notice-info is-dismissible">
            <p><?php _e('Thank you for installing Sky SEO Boost! Please configure your settings to get started.', 'sky-seo-boost'); ?></p>
        </div>
        <?php
    }
}
        ...
        <div class="notice notice-error is-dismissible">
            <p>
                ...
                if ($deactivation_notice === 'server_unavailable') {
                    _e('The plugin was deactivated because the license server is unavailable. Please contact support.', 'sky-seo-boost');
                } else {
                    _e('The plugin was deactivated due to a license issue.', 'sky-seo-boost');
                }
                ?>
            </p>
        </div>
